...
export const useRules = () => {
  ...
  const persianNumberOrAlphabet = {
    message: t('rules.persianNumberOrAlphabet'),
    pattern: regex.persianNumberOrAlphabet
  }
  ...
  const englishNumberOrAlphabet = {
    message: t('rules.englishNumberOrAlphabet'),
    pattern: regex.englishNumberOrAlphabet
  }
  const englishSpecialCharacter = {
    message: t('rules.englishSpecialCharacter'),
    pattern: regex.englishSpecialCharacter
  }
  const uppercase = { message: t('rules.uppercase'), pattern: regex.uppercase }
  const lowercase = { message: t('rules.lowercase'), pattern: regex.lowercase }
  const oneNumber = { message: t('rules.oneNumber'), pattern: regex.oneNumber }
  const oneSpecial = { message: t('rules.oneSpecial'), pattern: regex.oneSpecial }
